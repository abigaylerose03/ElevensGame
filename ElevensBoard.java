...
public class ElevensBoard {
    ...
    public boolean isLegal(List<Integer> selectedCards) {
        ...
        {
            int a = cards[selectedCards.get(0)].pointValue();
            int b = cards[selectedCards.get(1)].pointValue();
            return a + b == 11;
        ...
        {
            String[] s = {cards[selectedCards.get(0)].rank(), cards[selectedCards.get(1)].rank(), cards[selectedCards.get(2)].rank()}; 
            List<String> ranks = new ArrayList<String>();
            ranks.add(cards[selectedCards.get(0)].rank());
            ranks.add(cards[selectedCards.get(0)].rank());
            ranks.add(cards[selectedCards.get(0)].rank());
